...
export class NotificationsService {
  ...
  getAvailableNotificationTypes(): NotificationTypeDto[] {
    return [
      ...
      {
        key: 'whatIfAnalysis',
        title: 'What If Savings',
        description: 'Hypothetical savings opportunities based on category spending',
        category: 'Wallet',
        schedule: 'Every 3 days at 7 AM',
      },
      {
        key: 'topSpendingDay',
        title: 'Top Spending Day Insight',
        description: 'Analysis of which days of the week you spend the most',
        category: 'Wallet',
        schedule: 'Weekly',
      },
      {
